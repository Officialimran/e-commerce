    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-settings">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ url('admin/update-admin-password') }}">Update Pasword</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('admin/update-admin-details') }}">Update Details</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-adminmanage" aria-expanded="false" aria-controls="ui-adminmanage">
                <i class="icon-layout menu-icon"></i>
                <span class="menu-title">Admin Manage</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-adminmanage">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ url('admin/admins/admin') }}">Admin</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('admin/admins/subadmin') }}">SubAdmin</a></li>
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-catalog" aria-expanded="false" aria-controls="form-elements">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-usermangae" aria-expanded="false" aria-controls="ui-usermangae">
                <i class="icon-layout menu-icon"></i>
                <span class="menu-title">User Manage</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-usermangae">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ url('admin/user') }}">User</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('admin/subscribers') }}">Subscribera</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-filemanager" aria-expanded="false" aria-controls="ui-usermangae">
                <i class="icon-layout menu-icon"></i>
                <span class="menu-title">File Manager</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-filemanager">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ url('admin/filemanager') }}">Media Library</a></li>
                </ul>
            </div>
        </li>
        @endif
